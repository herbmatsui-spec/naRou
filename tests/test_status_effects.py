import pytest
from systems import StatusEffect, CombatSystem
from entity import Entity, Attributes

def test_status_effect_husk_and_regen():
    # Setup test entity
    attrs = Attributes(strength=10, endurance=10, dexterity=10, perception=10, learning=10, will=10, magic=10, charisma=10)
    entity = Entity(x=0, y=0, char="@", color=(255,255,255), name="TestEntity", speed=100, attributes=attrs)
    entity.max_hp = 100
    entity.hp = 50
    entity.energy = 100
