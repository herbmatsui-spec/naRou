...
from skill_eater_presentation_system import SkillEaterPresentationSystem, EMOTE_DIR, PresentationEvent
...
class TestSkillEaterPresentationIntegration(unittest.TestCase):
    ...
    def setUp(self):
        ...
        self.reincarnation = SkillEaterReincarnationSystem(self.registry, self.audio, self.presentation)
