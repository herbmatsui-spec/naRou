...
def test_build_dag_from_yaml():
    ...
    yaml_data = {
        ...
        "edges": [
            ...
            {"edge_id": "e2", "source": "choice", "target": "end", "type": "CHOICE", "choice_text": "終わる"},
        ],
    }
...
def test_narrative_executor_start():
    ...
    assert state.current_node_id in ["prologue_start", "prologue_accept", "prologue_decline"]
...
def test_ending_unlock_check():
    ...
    context = NarrativeContext(
        flags={"spared_cubs_resolved", "karma_good_50"},
        variables={"karma": 60}
    )
