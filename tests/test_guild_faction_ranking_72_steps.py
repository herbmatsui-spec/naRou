...
def test_all_72_steps_guild_faction():
    ...
    with open("data/guilds.yaml", encoding="utf-8") as f:
    ...
    assert any(
        b.get("type") == "daily_quest_bonus" for b in adv.get("membership_benefits", [])
    ), "Step 4 Failed"
    ...
    with open("data/factions.yaml", encoding="utf-8") as f:
    ...
    with open("data/guild_quests.yaml", encoding="utf-8") as f:
    ...
    with open("data/guild_rewards.yaml", encoding="utf-8") as f:
    ...
    with open("data/faction_war.yaml", encoding="utf-8") as f:
    ...
    with open("data/guild_skills.yaml", encoding="utf-8") as f:
