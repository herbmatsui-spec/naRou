...
class PetFusionRegistry:
    ...
    _instance: PetFusionRegistry | None = None
...
class PetFusionManager:
    ...
    def __init__(self, registry: PetFusionRegistry | None = None):
        self.registry = registry or REGISTRY

    def can_fuse(self, pets: list[Entity], player: Entity | None = None) -> str | None:
