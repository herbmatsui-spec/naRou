...
class ToxicityOverdriveManager:
    ...
    def can_trigger_overdrive(self, current_toxicity: float) -> bool:
        ...
        return (not self.is_active) and (not self.is_stunned) and (current_toxicity >= self.trigger_threshold)
    ...
    def hook_with_phase1_toxicity(self, phase1_toxicity_manager: Any, current_hp: int, max_hp: int) -> Dict[str, Any]:
