...
from systems import SurvivalSystem, ResistanceSet, AggroList, StatusEffect, Quest
...
class GameStateData:
    ...
    # ダンジョン状態
    dungeon_level: int = 1
    game_map: Optional[Any] = None  # GameMap型だが循環インポートを避けるためAnyに
    ...
    active_dialogue: Optional[Tuple[str, str]] = None
