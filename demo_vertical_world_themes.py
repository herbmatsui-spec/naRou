...
def demo_themed_content():
    ...
    print(f"   一般的なモンスター: {surface_plains_shallow.theme_data.get('enemy_pools', {}).get('common', [])}")
    print(f"   固有ボス: {surface_plains_shallow.theme_data.get('enemy_pools', {}).get('unique_boss')}")
    ...
    print(f"   一般的な資源: {surface_plains_shallow.theme_data.get('resources', {}).get('common', [])}")
    print()
    ...
    print(f"   一般的なモンスター: {surface_plains_shallow_ethereal.theme_data.get('enemy_pools', {}).get('common', [])}")
    print(f"   固有ボス: {surface_plains_shallow_ethereal.theme_data.get('enemy_pools', {}).get('unique_boss')}")
    print(f"   環境ハザード: {surface_plains_shallow_ethereal.theme_data.get('environmental_hazards', [])}")
    print()
    ...
    print(f"   一般的なモンスター: {underground_forest_shallow.theme_data.get('enemy_pools', {}).get('common', [])}")
    print(f"   固有ボス: {underground_forest_shallow.theme_data.get('enemy_pools', {}).get('unique_boss')}")
    print()
    ...
    print(f"   一般的なモンスター: {heaven_plains_mid.theme_data.get('enemy_pools', {}).get('common', [])}")
