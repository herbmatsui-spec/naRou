...
class LegacySkillRegistry:
    ...
    def get(self, skill_id: str) -> Optional[LegacySkillData]:
        """特定のレガシースキルデータを取得"""
...
class LegacySkillManager:
    ...
    def __init__(self, registry: Optional[LegacySkillRegistry] = None):
        self.registry = registry or REGISTRY
    
    def apply_legacy_effects(self, player: Any, effect_type: str = "skill_exp_boost", base_val: float = 100.0) -> float:
        """レガシースキルの効果を適用"""
        bonus_mult = 0.0
