...
class GuildManager:
    ...
    def __init__(self, registry: Optional[GuildRegistry] = None):
    ...
    def get_guild_info(self, player: 'Entity') -> Optional[GuildData]:
    ...
    def check_rank_up(self, player: 'Entity') -> Optional[str]:
