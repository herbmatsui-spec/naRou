...
def virtual_memory():
    ...
    return Mem(total=16 * 1024 * 1024 * 1024, available=8 * 1024 * 1024 * 1024, percent=10.0, used=8 * 1024 * 1024 * 1024, free=8 * 1024 * 1024 * 1024)

def disk_usage(path):
    Usage = namedtuple('Usage', ['total', 'used', 'free', 'percent'])
    return Usage(total=100 * 1024 * 1024 * 1024, used=10 * 1024 * 1024 * 1024, free=90 * 1024 * 1024 * 1024, percent=10.0)
