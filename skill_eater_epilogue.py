...
class EpilogueAndTransitionManager:
    ...
    def generate_epilogue_story(
        self, bequest_scores: Dict[str, int], donated_count: int
    ) -> Dict[str, Any]:
        ...
        return {"epilogue_story": story, "npc_farewell": npc_farewell, "epilogue_completed": True}
    ...
    def trigger_world_transition(
        self, target_world_id: str = "W1_Magic_Dominant"
    ) -> Dict[str, Any]:
