...
class SocialPackage(IPackage):
    ...
    def setup(self, kernel: Kernel) -> None:
        from faction_war_system import FactionWarManager, FactionWarRegistry
        from guild_quest_system import GuildQuestManager, GuildQuestRegistry
        from guild_skill_system import GuildSkillManager, GuildSkillRegistry
        from guild_system import GuildManager, GuildRegistry
        from pet_contract_system import PetContractManager, PetContractRegistry
        from pet_evolution_system import PetEvolutionManager, PetEvolutionRegistry
        from pet_fusion_system import PetFusionManager, PetFusionRegistry
        from procedural_quest_generator import (
            ProceduralQuestGenerator,
            ProceduralQuestManager,
            QuestGenerationRegistry,
        )
        from quest_scheduler import QuestScheduler
        from relationship_system import RelationshipManager, RelationshipRegistry
        ...
        kernel.register_system(
            "procedural_quest_manager", ProceduralQuestManager(procedural_quest_gen)
        )
