...
def convert_tmx_to_json(
    tmx_path: Path,
    output_path: Path,
    tileset_def_path: Path = Path("assets/tiles/tileset_def.json"),
) -> None:
    """
...
def parse_objectgroup(objgroup_elem: ET.Element) -> dict[str, Any] | None:
...
def parse_object(obj_elem: ET.Element) -> dict[str, Any] | None:
...
def parse_properties(properties_elem: ET.Element | None) -> dict[str, Any]:
