...
def repair_tests():
    ...
    result = subprocess.run("pytest -v --tb=short", shell=True, capture_output=True, text=True)
                ...
                if file.endswith(".yaml") or file.endswith(".yml"):
                    ...
                    try:
                        ...
                        if os.path.exists(backup_dir):
                            run_command(f"python restore.py --data {backup_dir}/latest_data_backup.tar.gz")
                            break
