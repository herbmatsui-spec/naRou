...
def main():
    ...
    parser.add_argument("--add-step", nargs=3, metavar=("ROLL_ID", "NAME", "ACTION"), help="Add step")
    parser.add_argument("--execute", help="Execute rollout")
    parser.add_argument("--execute-step", nargs=2, metavar=("ROLL_ID", "STEP"), help="Execute specific step")
