...
from constants import QUALITY_NORMAL
...
class Item:
    ...
    def tick_rot(self, ticks: int = 1) -> str | None:
...
class Inventory:
    ...
    def get_slot(self, slot_name: str) -> EquipmentSlot | None:
        for s in self.slots:
    ...
    def remove_item(self, item: Item, count: int = 1) -> Item | None:
