...
class EventScheduler:
    ...
    def get_current_seasonal_event(self, current_turn: int, current_quarter: Optional[int] = None) -> Optional[Any]:
        """
        ...
        for event_data in self.registry.all_events().values():
            ...
            elif hasattr(event_data, 'quarter') and event_data.quarter is not None and event_data.quarter == current_quarter:
                return event_data
        return None
