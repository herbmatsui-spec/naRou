...
class GuildQuestRegistry:
    ...
    _instance: Optional['GuildQuestRegistry'] = None
    ...
    def get(self, guild_id: str, quest_type: Optional[str] = None) -> List[GuildQuestData]:
    ...
    def get_quest_by_id(self, quest_id: str) -> Optional[GuildQuestData]:
        """IDから直接クエストデータを検索"""
...
class GuildQuestManager:
    ...
    def __init__(self, registry: Optional[GuildQuestRegistry] = None):
        self.registry = registry or REGISTRY

    def get_available_quests(self, player: 'Entity', quest_type: str = "daily") -> List[GuildQuestData]:
