...
## Step 1: data/skill_trees.yaml 基本構造作成
...
## Step 2: data/skill_trees.yaml 基本スキルツリー定義
...
## Step 3: data/skill_trees.yaml 剣術ツリー初期ティア完成
...
## Step 4: data/skill_trees.yaml 剣術ツリー2ティア目追加
...
## Step 5: data/skill_trees.yaml 剣術ツリー3ティア目追加
...
## Step 6: data/skill_trees.yaml 魔法スキルツリー追加
...
## Step 7: data/skill_trees.yaml 魔法ツリー詳細定義
...
## Step 8: data/skill_trees.yaml 体術スキルツリー追加
...
## Step 9: entity.py スキルツリー進捗フィールド追加
...
## Step 10: entity.py スキルポイントフィールド追加
...
## Step 11: skill_tree_system.py 新規ファイル作成
...
## Step 12: skill_tree_system.py SkillTreeEffectクラス定義
...
## Step 13: skill_tree_system.py SkillTreeTierクラス定義
...
## Step 14: skill_tree_system.py SkillTreeクラス定義
...
## Step 15: skill_tree_system.py SkillTreeRegistryクラス作成
...
## Step 16: skill_tree_system.py SkillTreeRegistry.load()実装
...
## Step 17: skill_tree_system.py SkillTreeRegistryアクセッサー追加
...
## Step 18: skill_tree_system.py SkillTreeManagerクラス作成
...
## Step 19: skill_tree_system.py SkillTreeManager.check_prerequisites実装
...
## Step 20: skill_tree_system.py SkillTreeManager.learn_skill実装
...
## Step 21: skill_tree_system.py SkillTreeManager.get_available_skills実装
...
## Step 22: skill_tree_system.py SkillTreeManager.get_learned_skills実装
...
## Step 23: entity.py gain_expメソッド修準備
...
## Step 24: entity.py gain_expメソッドにスキルポイント付与追加
...
## Step 25: game.py スキルツリーマネージャー参照追加
...
## Step 26: game.py _on_killメソッドスキルポイント追加（オプション）
...
## Step 27: game.py advance_worldメソッドスキルツリー定期チェック追加
...
## Step 28: ui_fx_systems.py スキルツリーUI基礎追加
...
## Step 29: game.py render_allメソッドスキルツリーUI追加
...
## Step 30: game.py メインループスキルツリーキー割り当て追加
...
## Step 32: data/jobs.yaml 初期ジョブ（見習い）定義
...
## Step 33: data/jobs.yaml 戦士ジョブ定義
...
## Step 34: data/jobs.yaml 剣聖ジョブ定義
...
## Step 35: data/jobs.yaml 魔法使いジョブ定義
...
## Step 36: data/jobs.yaml 大賢者ジョブ定義
...
## Step 37: entity.py ジョブ関連フィールド追加
...
## Step 38: job_system.py 新規ファイル作成
...
## Step 39: job_system.py JobEffectクラス定義
...
## Step 40: job_system.py JobDataクラス定義
...
## Step 41: job_system.py JobRegistryクラス作成
...
- ヒント: スキルツリーレジストリとほぼ同じ構造

## Step 42: job_system.py JobRegistry.load()実装
...
## Step 43: job_system.py JobManagerクラス作成
...
## Step 44: job_system.py JobManager.check_unlock_conditions実装
...
## Step 45: job_system.py JobManager.change_job実装
...
## Step 46: job_system.py JobManager.get_available_jobs実装
...
## Step 47: job_system.py JobManager.apply_job_stats実装
...
## Step 48: entity.py recalculate_statsメソッドジョブ補正追加準備
...
## Step 49: entity.py recalculate_statsメソッドにジョブ補正適用追加
...
## Step 51: game.py advance_worldメソッドジョブ経験値追加
...
## Step 52: entity.py gain_expメソッドジョブ経験値ボーナス追加（オプション）
...
## Step 53: game.py render_allメソッドジョブUI追加
...
## Step 54: game.py メインループジョブキー割り当て追加
...
## Step 55: data/exclusive_skills.yaml 基本構造作成
...
## Step 56: data/exclusive_skills.yaml シールドバッシュ定義
...
## Step 57: data/exclusive_skills.yaml 居合術定義
...
## Step 58: data/exclusive_skills.yaml メテオ定義
...
## Step 59: skill_tree_system.py エクスクルーシブスキルマネージャー追加準備
...
## Step 60: skill_tree_system.py エクスクルーシブスキルマネージャー実装
...
## Step 61: entity.py エクスクルーシブ・継承スキルフィールド追加
...
## Step 62: systems.py エクスクルーシブスキルCombatSystem統合準備
...
## Step 63: systems.py エクスクルーシブスキルCombatSystem実装
...
## Step 64: data/skill_fusion.yaml 基本構造作成
...
## Step 65: data/skill_fusion.yaml 魔剣術融合定義
...
## Step 66: data/skill_fusion.yaml 聖騎士融合定義
...
## Step 67: data/skill_fusion.yaml 影の暗殺者融合定義
...
## Step 68: skill_fusion_system.py 新規ファイル作成
...
## Step 69: skill_fusion_system.py FusionEffectクラス定義
...
## Step 70: skill_fusion_system.py FusionDataクラス定義
...
## Step 71: skill_fusion_system.py FusionRegistryクラス作成
...
## Step 72: skill_fusion_system.py FusionRegistry.load()実装
