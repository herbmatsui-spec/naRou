...
class NarrativeExecutor:
    ...
    def make_choice(self, player: "Entity", edge_id: str) -> List[str]:
        ...
        # 遷移実行
        transition_logs = self._execute_transition(dag, edge, context, state)
        logs.extend(transition_logs)
        return logs
