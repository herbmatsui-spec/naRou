...
class ReincarnationDungeonRegistry:
    ...
    def get(self, dungeon_id: str) -> Optional[ReincarnationDungeonData]:
        """特定の転生ダンジョンデータを取得"""
...
class ReincarnationDungeonManager:
    ...
    def __init__(self, registry: Optional[ReincarnationDungeonRegistry] = None):
    ...
    def is_dungeon_unlocked(self, player: Any, dungeon_id: str) -> bool:
        ...
        # 転生回数条件をチェック
        reinc_count = player if isinstance(player, int) else getattr(player, "reincarnation_count", 0)
