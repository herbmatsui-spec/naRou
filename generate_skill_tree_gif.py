...
scenes = [
    # Scene 1: Skill Tree Overview
    {
        ...
        "panels": [
            {"name": "【戦士の道】", "skills": ["剣術 Lv.5 ████████░░", "重装備 Lv.3 █████░░░░░", "盾防御 Lv.4 ███████░░░", "戦闘狂 Lv.2 ████░░░░░░", "戦吼 Lv.1 ██░░░░░░░░"], "color": ORANGE},
            {"name": "【魔法の道】", "skills": ["火炎魔法 Lv.4 ███████░░░", "氷結魔法 Lv.3 █████░░░░░", "雷撃魔法 Lv.2 ████░░░░░░", "治癒魔法 Lv.5 ████████░░", "召喚魔法 Lv.1 ██░░░░░░░░"], "color": BLUE},
            {"name": "【特殊・神秘】", "skills": ["錬金術 Lv.3 █████░░░░░", "鑑定眼 Lv.4 ███████░░░", "交渉術 Lv.2 ████░░░░░░", "幸運 Lv.3 █████░░░░░", "神秘学 Lv.1 ██░░░░░░░░"], "color": PURPLE},
        ],
    ...
    # Scene 2: Job System & Class Change
    {
        ...
        "panels": [
            {"name": "【基礎職】", "skills": ["ウォーリア ████████████ Lv.15", "メイジ ██████████░░ Lv.12", "シーフ ████████░░░░ Lv.10", "クレリック ██████░░░░░░ Lv.8", "レンジャー ████░░░░░░░░ Lv.6"], "color": GREEN},
            {"name": "【上位職 (転職済)】", "skills": ["パラディン ★ 解放済", "アークメイジ ★ 解放済", "アサシン ★ 解放済", "ハイプリースト ░ 条件未達", "スナイパー ░ 条件未達"], "color": GOLD},
            {"name": "【マスター職 (NG+)】", "skills": ["神聖騎士王 ░ NG+1で解放", "賢者の塔 ░ NG+1で解放", "影の支配者 ░ NG+1で解放"], "color": PURPLE},
        ],
    ...
    # Scene 3: Skill Fusion & Evolution
    {
        ...
        "panels": [
            {"name": "【スキル融合 実験中】", "skills": ["剣術 Lv.5 + 火炎魔法 Lv.4", "    ↓ 融合実行 ↓", "『炎剣・業火斬』 解放!", "消費SP: 15 + 融合触媒×1", "成功率: 78% (熟練度ボーナス+5%)"], "color": ORANGE},
            {"name": "【覚醒スキル】", "skills": ["条件: 基礎スキルLv.5 + 特定クエスト", "神威・次元斬 (剣術覚醒)", "星屑の杖 (魔法覚醒)", "影縫い (特殊覚醒)", "各覚醒で専用エフェクト獲得"], "color": PURPLE},
            {"name": "【継承スキル (NG+)】", "skills": ["輪廻転生で継承可能なレガシー", "『不屈の闘志』 HP+20% 防御+15%", "『魔力の奔流』 MP+30% 詠唱-20%", "『幸運の女神の微笑み』 ドロップ+50%", "次回プレイで即座に使用可能"], "color": GOLD},
        ],
        "info": "融合レシピ: 図鑑/ギルド/古文書で発見  |  失敗時: 素材消失なし SPのみ消費  |  [F]:融合 [A]:覚醒",
        "fx": [("particle", "✧", (25, 12), PURPLE), ("particle", "🔥", (28, 6), ORANGE)]
    },
]
    ...
    for sub in range(5):
        ...
        for p_idx, panel in enumerate(sc["panels"]):
            ...
            for s_idx, skill in enumerate(panel["skills"]):
                sy = py + 42 + s_idx * 30
                skill_color = GOLD if "解放" in skill or "★" in skill else (GREEN if "Lv." in skill and "█" in skill else TEXT_WHITE)
                if "↓" in skill:
                    skill_color = ORANGE
