...
def pack_material(roughness: np.ndarray, metallic: np.ndarray, 
                  emissive: np.ndarray, ao: np.ndarray) -> np.ndarray:
...
def unpack_material(packed: np.ndarray) -> Tuple[np.ndarray, np.ndarray, np.ndarray, np.ndarray]:
