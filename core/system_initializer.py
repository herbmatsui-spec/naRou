...
from ui_fx_systems import (
    LookCursor, ContextMenu,
    TutorialManager, NotificationManager
)
...
class SystemInitializer:
    ...
    @staticmethod
    def initialize_ui_and_services(engine: Engine) -> Tuple[LookCursor, ContextMenu, TutorialManager, NotificationManager, any]:
        ...
        return look_cursor, context_menu, tutorial_manager, notification_manager, web_server
